  ...
  return (
    <Combobox  store={combobox} onOptionSubmit={handleValueSelect} withinPortal={false}>
      <Combobox.DropdownTarget>
        <PillsInput variant='ulstyleed' rightSection={<IconSelector />} onClick={() => combobox.toggleDropdown()}
         leftSection={
          <div className='p-1 mr-2 rounded-full text-bright-sun-400 bg-mine-shaft-900'><props.icon/></div>
         } >
